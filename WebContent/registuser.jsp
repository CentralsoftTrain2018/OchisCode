      ...
      <div id="content">
        ...
        <div id="main">
          ...
          <div class="normal">
            <div class="emphasis">
              <h2>新規登録</h2>
              <form method="POST" action="RegistUserServlet" onSubmit="return doub()">
                登録情報を入力してください <br>
                <table>
                  <tr>
                    <td>ユーザーID(半角英数字4文字以上)</td>
                    <td><input name="userid" type="text" required="required"
                  ...
                  <tr>
                    ...
                    <td><input type="password" name="passwordConfirm"
                      id="passwordConfirm" required oninput="check(this)"></td>
                  </tr>
                  <tr>
                    <td>身長(半角数字)</td>
                  ...
                  <tr>
                    <td>予算(半角数字)</td>
                    <td><input name="budget" type="number"
                      required="required"></td>
                  </tr>
                  <tr>
                    <td>性別</td>
                    <td><input name="sex" type="radio" checked="checked"
                      value="男">男<input name="sex" type="radio" value="女">女</td>
                  </tr>
                </table>
