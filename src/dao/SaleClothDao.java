...
public class SaleClothDao
{
    ...
    public List<SaleClothVo> getSaleClothList(String userid, String minmax) throws SQLException {
        PreparedStatement stmt = null;
        ...
        while (userClothSet.next()) {
            List<SaleClothVo> recomCloth = getRecomCloth(userClothSet.getInt(1), minmax);
    ...
    //持ち服を指定して、お勧めの服を取得する
    public List<SaleClothVo> getRecomCloth(int clothid, String minmax) throws SQLException {
        List<SaleClothVo> recomClothList = new ArrayList<SaleClothVo>();
